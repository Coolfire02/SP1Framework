...
enum ARTTYPE
{
	...
	ABILITY_UNLOCKMG_ART,
	ABILITY_ZOOM_ART,

	SHOP_HOSE_ABSORBER_I_ART,
	SHOP_HOSE_HOLYWATER_ART,
	SHOP_HOSE_MAGESTICALWATER_ART,
	SHOP_HOSE_MONEYDUPLICATOR_ART,
	SHOP_HOSE_MONEYSALVAGER_ART,
